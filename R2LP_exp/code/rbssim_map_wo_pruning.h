...
public:
    ...
    void rbspush_idx(double eps){
        ...
        int norandnum = 0;
        int all_norandum = 0;
        long long deter_pushnum = 0;
        long long rand_pushnum = 0;
        mytime.start();
        ...
        cout << "allnorandom num = " << all_norandum << endl << endl;
        cout << "without pruning strategy" << endl;
        cout << "deterministic push num = " << deter_pushnum << endl;
        cout << "randomized push num = " << rand_pushnum << endl;
        cout << "total push num = " << deter_pushnum + rand_pushnum << endl << endl;
        //appr.push_back(ppr);
