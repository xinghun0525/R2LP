...
int main(int argc, char **argv){
    ...
    string anspath;
    if(algo_name == "r2lp")
    	anspath = base_path + "../R2LP-sim_exp/result_eps/" + filename + "/eps_" + seps;
        ...
        anspath = base_path + "../SimRankRelease-master_exp_flp_large_graph/Local-Push/eps_result_flp/" + filename + ".ans_eps" + to_string(eps);
