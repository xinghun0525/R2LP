...
#include "Timer.h"
#include "rbssim_map_threshold_with_mc.h"
using namespace std; 
...
int main(int argc, char **argv){
    ...
    Rbs myrbs = Rbs(dataname, threshold, rou, eps_init, eps_term);
	...
	string outputfile = "../result/threshold/" + filename + "/with_mc_" + "t" + to_string(threshold) + "_r" + to_string(rou);
